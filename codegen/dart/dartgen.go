...
func genFunc(name string, emoji string, isError bool) string {
	...
	s := string(a)
	endf := "  /// A debug message for " + s + "\n"
	endf += "  ///\n"
	endf += "  /// emoji: " + emoji + "\n"
	endf += "  String " + s + `([dynamic obj, String? domain]) => emo("` + emoji + `", obj, domain);
`
	return endf
}
...
func GenCode() {
	...
	_template := `// Code generated by codegen/dart/dartgen.go; DO NOT EDIT.` + "\n" +
		TemplateStart + "\n" + fs + TemplateEnd

	_filepath, err := filepath.Abs("./lang/dart/lib/src/debug.dart")
	if err != nil {
